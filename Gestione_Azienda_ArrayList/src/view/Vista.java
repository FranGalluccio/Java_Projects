...
public class Vista {
	...
	public void inserimento(Persona persona) {
		if(persona != null) {
			if(persona instanceof Dirigente) {
				setPersona(persona);
				((Dirigente) persona).setAreaDiResponsabilita(leggiStringa("Inserisci Area Di Responsabilità: "));
				...
				((Manager)persona).setAreaDiResponsabilita(leggiStringa("Inserisci Area di Resposabilità: "));
			}
	...
	public void modifica(Persona persona) {
		...
		if(persona instanceof Dirigente) {
			...
			s = leggiStringa("Area Di Responsabilità [" + ((Dirigente)persona).getAreaDiResponsabilita() + "]: ");
			if(s != "") {
			...
			s = leggiStringa("Area Di Responsabilità [" + ((Manager)persona).getAreaDiResponsabilita() + "]: ");
			if(s != "") {
			...
			s = leggiStringa("Area Di Responsabilità [" + ((Dipendente)persona).getRuoloAziendale() + "]: ");
			if(s != "") {
	...
	public void stampaScheda(Persona persona) {
		if(persona instanceof Dirigente) {
			...
			System.out.println("Area Di Responsabilità = " + ((Dirigente)persona).getAreaDiResponsabilita());
			...
			System.out.println("Area Di Responsabilità = " + ((Manager)persona).getAreaDiResponsabilita());
		}else if(persona instanceof Dipendente) {
			stampaSchedaPersona(persona);
